...
def decide_speed(threat_list, speed_number):
    ...
    if speed_number > 80 and total_threats == 0:
        return -1.0
...
threat_list = ['Warning', 'Safe', 'Safe', 'Safe', 'Safe', 'Safe', 'Safe', 'Safe', 'Critical']
speed_number = 100

result = decide_speed(threat_list, speed_number)
